/* Ícones SVG (stroke). Herdam a cor via currentColor. */
...
export const IcFinanceiro = () => (
  <svg {...base}><rect x="1" y="4" width="22" height="16" rx="2" /><line x1="1" y1="10" x2="23" y2="10" /></svg>
)
export const IcChat = () => (
  <svg {...base}><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg>
)
export const IcTemplates = () => (
  <svg {...base}><path d="M20.5 7.5l-2-2M18.5 5.5l-11 11M9.5 15.5l-2-2M3.5 20.5l3-3" /><path d="M4 4l3 3M14 14l3 3M2 6l4-4 2 2M22 18l-4 4-2-2" /></svg>
)
...
export const IcTreino = () => (
  <svg {...base}><path d="M6.5 6.5l11 11M21 21l-1-1M3 3l1 1M18 22l4-4M2 6l4-4M6 18l-4 4M22 18l-4-4" /><path d="M14.5 6.5l3 3M6.5 14.5l3 3" /></svg>
)
...
export const IcRaio = () => (
  <svg {...base}><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" /></svg>
)
export const IcMais = () => (
